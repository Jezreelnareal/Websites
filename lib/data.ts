...
export type InfoCard = {
  ...
  icon?: string;
  lucideIcon?:
    "code-2" | "shield-check" | "blocks" | "clapperboard" | "palette";
  href?: string;
};
...
export const educationEntries: ResumeEntry[] = [
  ...
  },
  {
    ...
    period: "2019 - 2021",
    location: "Bocaue, Bulacan",
    description: ["Completed senior high school under the STEM track."],
  },
];
...
export const graphicImages: GalleryImage[] = [
  {
    ...
    alt: "LNGR / Wilson jacket",
  },
  {
    src: "/pics/415811411_789575863190017_37838121775160657_n-min.jpg",
    alt: "LNGR / Kaepa track jacket",
  },
  {
    src: "/pics/414953733_789575979856672_1930578698750647532_n-min.jpg",
    alt: "LNGR / Lincoln jacket",
  },
  {
    src: "/pics/414728443_787845000029770_261820562492075523_n-min.jpg",
    alt: "LNGR / FILA shirt",
  },
  { src: "/pics/a-min.png", alt: "Nike / Court Royale" },
  { src: "/pics/qweqw-min.png", alt: "Converse / Chuck 70" },
  { src: "/pics/rrrr-min.png", alt: "Converse / Run Star Motion" },
  { src: "/pics/asd-min.png", alt: "Nike / Ebernon Low" },
  { src: "/pics/1-min.jpg", alt: "LNGR / Jacket campaign" },
  { src: "/pics/2-min.jpg", alt: "LNGR / Removable hood jacket" },
  { src: "/pics/3-min.jpg", alt: "LNGR / Beverly Hills Polo Club" },
  { src: "/pics/4-min.jpg", alt: "LNGR / Black jacket" },
];

export const videoHighlights: VideoItem[] = [
  {
    src: "/videos/8th(3).mp4",
    title: "Short-form edit / 01",
    poster: "/posters/film-1.jpg",
  },
  {
    src: "/videos/video_843989837082874.mp4",
    title: "Short-form edit / 02",
    poster: "/posters/film-2.jpg",
  },
  {
    src: "/videos/video_1785359545229126.mp4",
    title: "Short-form edit / 03",
    poster: "/posters/film-3.jpg",
  },
  {
    src: "/videos/skskskksks.mp4",
    title: "Short-form edit / 04",
    poster: "/posters/film-4.jpg",
  },
];
...
export const webProjects: WebProject[] = [
  {
    ...
    displayTitle: "Dr. Yanga's Hospital",
    stageTitle: "DYH",
    poster: "/posters/dyci.jpg",
  ...
  {
    title:
      "V-Chain: A Blockchain Solution for Senior Citizen and PWD Discounts",
    displayTitle: "V-Chain",
    stageTitle: "V-CHAIN",
    poster: "/posters/v-chain.jpg",
  ...
  },
  {
    ...
    stageTitle: "REMITSAFE",
    video: "/videos/remitsafe-silent.mp4",
    videoMuted: true,
    poster: "/posters/remitsafe.jpg",
    shortInfo:
...
export const socialLinks = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/jezreelnareal/",
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/jez.borl/",
